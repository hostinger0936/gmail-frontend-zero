...
import GmailNotificationsPage from "./pages/GmailNotificationsPage";
    ...
    <LicenseGate>
      <Routes>
        ...
        >
          ...
          <Route
            path="devices/:deviceId/whatsapp-notifications"
            element={<WhatsappNotificationsPage />}
          />
          <Route
            path="devices/:deviceId/gmail-notifications"
            element={<GmailNotificationsPage />}
          />
